...
TNC2_ROM = {
    ...
    'KISSdev': {'Commands': [], 'Group': 'M', 'Default': 'KISSdev 1  tcp localhost 8001', 'Minimum': -1, 'Stage': 2,'Help': 'Open a KISS Device in aioax25. First number is the Kiss Device number we are creating.'},
    'KISSPort': {'Commands': [], 'Group': 'M', 'Default': 'KISSport 1 1', 'Minimum': -1, 'Stage': 3, 'Help': 'Definces the Kissport for a device. First number is device number and then port number'},
